...
public partial class TotalForm : Form
{
    ...
    private void addEmployeeButton_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var employeeForm = new AddEmployeeForm(department);
    ...
    private void updateEmployeeButton_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var form = new AddEmployeeForm(employeeToUpdate);
            form.ShowDialog();
    ...
    private void fullNameSortButton_Click_1(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                employees = selectedDepartment.GetEmployees().OrderBy(x => x.LastName + x.FirstName).ToList();
            }
            else
            {
                employees = selectedDepartment.GetEmployees().OrderByDescending(x => x.LastName + x.FirstName).ToList();
            }
    ...
    private void salarySortButton_Click_1(object sender, EventArgs e)
    {
        try
        {
            var selectedDepartment = GetSelectedDepartment();
    ...
    private void ascendingFullNameCheckBox_CheckedChanged(object sender, EventArgs e)
    {
